...
export default async function GitHubStats() {
  ...
  return (
    <section id="github" className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
      <h2 className="font-mono text-2xl md:text-3xl font-bold mb-6 sm:mb-10">{"//"} github</h2>
